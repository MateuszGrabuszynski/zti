...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>singledispatch &#8212; ZTI  documentation</title>
...
a mechanism in the <code class="docutils literal notranslate"><span class="pre">functools</span></code> standard library module in Python 3.4
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">singledispatch</span> <span class="k">import</span> <span class="n">singledispatch</span>
...
<code class="docutils literal notranslate"><span class="pre">register()</span></code> attribute of the generic function. It is a decorator,
...
<p>The <code class="docutils literal notranslate"><span class="pre">register()</span></code> attribute returns the undecorated function which
...
<p>For example, <code class="docutils literal notranslate"><span class="pre">3.4.0.0</span></code> is the <strong>first</strong> release of <code class="docutils literal notranslate"><span class="pre">singledispatch</span></code>
...
for finding and fixing the <code class="docutils literal notranslate"><span class="pre">setup.py</span></code> issue.</p>
</div>
...
following content.</p>
<p><code class="docutils literal notranslate"><span class="pre">singledispatch</span></code> is converted using <a class="reference external" href="http://pypi.python.org/pypi/six">six</a> so that a single codebase can be
...
<ul class="simple">
<li>the <code class="docutils literal notranslate"><span class="pre">upstream</span></code> branch holds unchanged files synchronized from the
...
on this branch.</li>
<li>the <code class="docutils literal notranslate"><span class="pre">default</span></code> branch holds the manually translated version and this
...
<h1 class="logo"><a href="../../../../index.html">ZTI</a></h1>
...
<script type="text/javascript">$('#searchbox').show(0);</script>
    ...
    <div class="footer">
      &copy;2019, Adam Godziński, Adam Linke, Mateusz Grabuszyński.
      ...
      |
      <a href="../../../../_sources/venv/Lib/site-packages/singledispatch-3.4.0.3.dist-info/DESCRIPTION.rst.txt"
